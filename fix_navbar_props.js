const fs = require('fs');
let code = fs.readFileSync('bupzo-frontend/app/product/[id]/page.tsx', 'utf8');
...
fs.writeFileSync('bupzo-frontend/app/product/[id]/page.tsx', code);
console.log("Fixed Navbar props in product page");
