const fs = require('fs');
const file = 'bupzo-frontend/components/CustomerHome.tsx';
      ...
      <div className="container mx-auto px-4">
        ...
        {products.length > 0 && (
           <div className="text-center mt-12">
              <button className="bg-[#e52e06] hover:bg-[#cc2805] text-white px-10 py-3 rounded-full font-bold uppercase transition">
                 View All Products
              </button>
           </div>
        )}
...
fs.writeFileSync(file, newHome);
console.log('CustomerHome updated to Sprylo theme!');
