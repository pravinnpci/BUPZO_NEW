  ...
  return (
    <div className="w-full pb-20 bg-white">
      ...
      <div className="w-full bg-[#fce5df] py-12 flex flex-col items-center justify-center text-center">
         <h1 className="text-4xl font-extrabold text-[#232f3e] uppercase tracking-wide mb-2">Products</h1>
         <p className="text-[#e52e06] font-bold text-sm uppercase">Home / Products</p>
      </div>
